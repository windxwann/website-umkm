...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-lg font-black text-slate-900 tracking-tight leading-none">Tambah Produk</h1>
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Buat Menu Baru</p>
        </div>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 sm:p-8">
                    <div class="space-y-5">
                        ...
                        <!-- Stok -->
                        <div>
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2 px-1">Stok Awal (Opsional)</label>
                            <div class="relative group">
