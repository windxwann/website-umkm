...
<div class="max-w-xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-lg font-black text-slate-900 tracking-tight leading-none">Edit Pengguna</h1>
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">#USER-{{ str_pad($user->id, 4, '0', STR_PAD_LEFT) }}</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border-none rounded-2xl text-xs font-bold focus:ring-4 focus:ring-orange-500/5 transition-all">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border-none rounded-2xl text-xs font-bold focus:ring-4 focus:ring-orange-500/5 transition-all">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" class="w-full pl-11 pr-4 py-3 bg-slate-50 border-none rounded-2xl text-xs font-bold focus:ring-4 focus:ring-orange-500/5 transition-all">
                    </div>
                </div>
            </div>
