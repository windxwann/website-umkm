...
<div class="container mx-auto px-4 py-4 md:py-8">
    ...
    <div class="mb-6 md:mb-8 bg-gradient-to-r from-orange-600 to-orange-500 rounded-xl p-4 md:p-6 text-white shadow-lg">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold mb-1 md:mb-2">Tambah Produk Baru</h1>
                <p class="text-orange-100 text-sm md:text-base">
                    <i class="fas fa-plus-circle mr-2"></i>Isi formulir untuk menambahkan produk baru
                </p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="category_id" required class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent appearance-none">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            <textarea name="description" rows="4" 
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition resize-y">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            ...
                            <div class="flex-shrink-0">
                                <template x-if="!imagePreview">
                                    <div class="w-32 h-32 bg-gray-100 rounded-lg flex flex-col items-center justify-center border-2 border-dashed border-gray-300">
                                        <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-1"></i>
                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    ...
                                    <button type="button" 
                                        ...
                                        <span x-text="imageName || 'Klik untuk pilih gambar'"></span>
                                    </button>
                                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 mt-8 pt-4 border-t">
                    ...
                    <button 
                        type="submit"
                        class="bg-orange-600 text-white py-3 px-4 rounded-lg hover:bg-orange-700 transition font-semibold flex items-center justify-center shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed">
                    ...
                    <a 
                        ...
                        role="button"
                        class="bg-gray-500 text-white py-3 px-4 rounded-lg hover:bg-gray-600 transition font-semibold flex items-center justify-center text-center shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-400">
        ...
        <div class="mt-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h4 class="font-semibold text-blue-800 text-sm md:text-base">Tips Mengisi Produk</h4>
                    <ul class="text-xs md:text-sm text-blue-700 mt-1 space-y-1">
                        <li><i class="fas fa-check-circle mr-1 text-xs"></i> Gunakan nama produk yang jelas dan mudah diingat</li>
                        <li><i class="fas fa-check-circle mr-1 text-xs"></i> Upload gambar dengan kualitas baik untuk menarik pelanggan</li>
                        <li><i class="fas fa-check-circle mr-1 text-xs"></i> Deskripsi produk membantu pelanggan memahami menu</li>
                        <li><i class="fas fa-check-circle mr-1 text-xs"></i> Nonaktifkan produk jika sedang habis, bukan menghapus</li>
                    </ul>
                </div>
            </div>
        </div>
